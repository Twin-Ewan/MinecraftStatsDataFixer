...
var VerRanges;
(function (VerRanges) {
    VerRanges[VerRanges["UnlitTorch"] = 1] = "UnlitTorch";
    VerRanges[VerRanges["Namespace"] = 2] = "Namespace";
...
async function filePreview() {
    ...
    if (files.length) {
        ...
        let previewFile;
        if (loadedFile) {
            previewFile = await (loadedFile === null || loadedFile === void 0 ? void 0 : loadedFile.text());
...
async function Load() {
    ...
    if (files.length) {
        ...
        if (loadedFile) {
            statFile = await (loadedFile === null || loadedFile === void 0 ? void 0 : loadedFile.text());
